...
from .read_files import func_read_key_from_csv
from .read_files import func_split_list_data
...
def func_split_audio_from_video_16k(video_root, save_root):
    ...
    for video_path in tqdm.tqdm(glob.glob(video_root+'/*')):
        ...
        cmd = f"ffmpeg -loglevel quiet -y -i {video_path} -ar 16000 -ac 1 {audio_path}" #%('ffmpeg', video_path, audio_path) # linux
